...
rho2 = config.boundary.bottom.material.rho;

cb   = config.boundary.bottom.material.c;
attn = config.boundary.bottom.material.attn;

cbx = complex_bottom_speed_from_dbwl(cb, attn);
